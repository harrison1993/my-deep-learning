...
# 聆听翻译 这只是一个简单的批量操作方法。我写了它，以便它包含所有数据。有时你会在最后丢掉一些数据，以确保你有完整的批次。这里我只是扩展最后一批以包含剩余的数据。
...
# 聆听翻译 到目前为止，我们一直在为您提供培训代码。在这里，我将给你更多的挑战，并且你编写代码来训练网络。当然，如果您需要帮助，您将能够看到我的解决方案。使用我之前编写的get_batches函数来获取像get_batches（train_x，train_y）中的x，y这样的批次。或者写你自己的！
